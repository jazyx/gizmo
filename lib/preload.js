...
// Importing Jazyx runs Session.set({ Jazyx }), which makes the data
// available globally. Elsewhere, the same data is available through
// Session.get("Jazyx")
import { Jazyx } from './jazyx'
import { removeFrom } from './utilities.js'


export const preload = (milliseconds) => {
  const sections   = Object.keys(Jazyx)
